...
Find articles by [Jian Gu](https://pubmed.ncbi.nlm.nih.gov/?term=%22Gu%20J%22%5BAuthor%5D)
...
Statistical testing to evaluate associations of torsional (TAN) and vertical (VAN) ocular misalignment with SMS were carried out via a series of two-sample *t*-tests within each astronaut individually to provide information on the following: (1) whether the two pre-flight datasets are the same or different from each other, (2) whether the two post-flight datasets are the same or different from each other and (3) whether the (grouped) pre-flight data are different from the (grouped) post-flight data. The *t*-tests were performed after removing outliers, which were defined as values more than three scaled median absolute deviations from the median, where median absolute deviation is a measure of the deviation of the values from the median (analogous to the standard deviation for data from normal distributions) and can be reduced to a sequential decision tree for prediction of individual SMS susceptibility (Supplementary Note [2](#MOESM1)). There are several reasons for this individual testing as opposed to a pooled analysis across subjects. First, the high variability across subjects (typical of many neurovestibular assessments), combined with the small subject pool, makes it unlikely that there would be sufficient statistical power in a pooled analysis. Second, individual testing permits a stepwise approach in which a series of tests can lead to a predictive metric. Finally, SMS is notoriously idiosyncratic, and spaceflight measures are subject to many confounds, which supports a focused longitudinal examination.
...
All statistical analyses were conducted using SAS v.9.4. Before statistical analysis of cognitive performance, all cognition data were standardized via *z*-scoring to facilitate comparisons across the different neurocognitive domains, as well as to allow the effects to be interpreted as effect sizes. Mixed-effects models using PROC MIXED with a random subject intercept were used to test astronaut behavioural and physiological responses to short-duration spaceflight across mission phases. Repeated measures were nested within subjects and differences between responses during both the in-flight and post-flight periods were tested relative to the pre-flight period using change scores generated for each astronaut from the average of an outcome for each mission phase. Post hoc analyses that tested differences between astronauts and mission phases were corrected for multiple comparisons based on the false discovery rate method with a significance threshold of *P* < 0.05 (refs. [51](#CR51)); both unadjusted and adjusted *P* values are reported. For crew-level differences between mission phases, Type III effects are reported.
...
[Supplementary Information](/articles/instance/11357997/bin/41586_2024_7648_MOESM1_ESM.docx) (58.9KB, docx)

The Supplementary Information contains Supplementary Notes 1–3 and Tables 1–7. The notes provide information on and results of statistical analyses. The tables provide information on the amount and type of data collected, as well as findings from immunological, cardiovascular and neurobehavioural studies of the Inspiration4 astronauts.

[Reporting Summary](/articles/instance/11357997/bin/41586_2024_7648_MOESM2_ESM.pdf) (2.7MB, pdf)
...
*Nature* thanks Jochen Schwenk, Balazs Aczel and the other, anonymous, reviewer(s) for their contribution to the peer review of this work.
...
* 2.Afshinnekoo, E. et al. Fundamental biological features of spaceflight: advancing the field to enable deep-space exploration. *Cell***183**, 1162–1184 (2020).
...
* 3.Urquieta, E., Wu, J., Hury, J. & Donoviel, D. Establishment of an open biomedical database for commercial spaceflight. *Nat. Med.***28**, 611–612 (2022).
   [[DOI](https://doi.org/10.1038/s41591-022-01761-y)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/35318465/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Urquieta,%20E.,%20Wu,%20J.,%20Hury,%20J.%20&%20Donoviel,%20D.%20Establishment%20of%20an%20open%20biomedical%20database%20for%20commercial%20spaceflight.%20Nat.%20Med.28,%20611%E2%80%93612%20(2022).)]
* 4.Kim, J. et al. Single-cell multi-ome and immune profiles of the Inspiration4 crew reveal cell-type, sex, and microbiome-specific responses and recovery. *Nat. Commun.***15**, 4954 (2024).
...
* 5.Overbey, E. G. et al. The Space Omics and Medical Atlas (SOMA): a comprehensive data resource and international biobank for astronauts. *Nature*10.1038/s41586-024-07639-y (2024). [[DOI](https://doi.org/10.1038/s41586-024-07639-y)] [[PMC free article](/articles/PMC11357981/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/38862028/)]
* 6.Garcia-Medina, J. S. et al. Genome and clonal hematopoiesis stability contrasts with immune, cfDNA, mitochondrial, and telomere length changes during short duration spaceflight. *Precis. Clin. Med.***7**, pbae007 (2024).
   [[DOI](https://doi.org/10.1093/pcmedi/pbae007)] [[PMC free article](/articles/PMC11022651/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/38634106/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Garcia-Medina,%20J.%20S.%20et%20al.%20Genome%20and%20clonal%20hematopoiesis%20stability%20contrasts%20with%20immune,%20cfDNA,%20mitochondrial,%20and%20telomere%20length%20changes%20during%20short%20duration%20spaceflight.%20Precis.%20Clin.%20Med.7,%20pbae007%20(2024).)]
* 7.Houerbi, N. et al. Secretome profiling captures acute changes in oxidative stress, brain homeostasis and coagulation from spaceflight. *Nat. Commun.***15**, 4862 (2024).
...
* 12.Crucian, B. et al. Alterations in adaptive immunity persist during long-duration spaceflight. *NPJ Microgravity***1**, 15013 (2015).
...
* 13.Mehta, S. K. et al. Multiple latent viruses reactivate in astronauts during Space Shuttle missions. *Brain Behav. Immun.***41**, 210–217 (2014).
...
* 14.Mehta, S. K. et al. Latent virus reactivation in astronauts on the international space station. *NPJ Microgravity***3**, 11 (2017).
...
* 15.Elko, E. A. et al. COVID-19 vaccination elicits an evolving, cross-reactive antibody response to epitopes conserved with endemic coronavirus spike proteins. *Cell Rep.***40**, 111022 (2022).
   [[DOI](https://doi.org/10.1016/j.celrep.2022.111022)] [[PMC free article](/articles/PMC9188999/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/35753310/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Elko,%20E.%20A.%20et%20al.%20COVID-19%20vaccination%20elicits%20an%20evolving,%20cross-reactive%20antibody%20response%20to%20epitopes%20conserved%20with%20endemic%20coronavirus%20spike%20proteins.%20Cell%20Rep.40,%20111022%20(2022).)]
* 16.Henson, S. N. et al. PepSeq: a fully in vitro platform for highly multiplexed serology using customizable DNA-barcoded peptide libraries. *Nat. Protoc.***18**, 396–423 (2022).
   [[DOI](https://doi.org/10.1038/s41596-022-00766-8)] [[PMC free article](/articles/PMC10339795/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/36385198/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Henson,%20S.%20N.%20et%20al.%20PepSeq:%20a%20fully%20in%20vitro%20platform%20for%20highly%20multiplexed%20serology%20using%20customizable%20DNA-barcoded%20peptide%20libraries.%20Nat.%20Protoc.18,%20396%E2%80%93423%20(2022).)]
* 17.Ladner, J. T. et al. Epitope-resolved profiling of the SARS-CoV-2 antibody response identifies cross-reactivity with endemic human coronaviruses. *Cell Rep. Med.***2**, 100189 (2021).
   [[DOI](https://doi.org/10.1016/j.xcrm.2020.100189)] [[PMC free article](/articles/PMC7816965/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33495758/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Ladner,%20J.%20T.%20et%20al.%20Epitope-resolved%20profiling%20of%20the%20SARS-CoV-2%20antibody%20response%20identifies%20cross-reactivity%20with%20endemic%20human%20coronaviruses.%20Cell%20Rep.%20Med.2,%20100189%20(2021).)]
* 18.Pierson, D. L., Stowe, R. P., Phillips, T. M., Lugg, D. J. & Mehta, S. K. Epstein–Barr virus shedding by astronauts during space flight. *Brain Behav. Immun.***19**, 235–242 (2005).
...
* 19.Kelley, E. J. et al. Virome-wide detection of natural infection events and the associated antibody dynamics using longitudinal highly-multiplexed serology. *Nat. Commun.***14**, 1783 (2023).
   [[DOI](https://doi.org/10.1038/s41467-023-37378-z)] [[PMC free article](/articles/PMC10062260/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/36997517/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Kelley,%20E.%20J.%20et%20al.%20Virome-wide%20detection%20of%20natural%20infection%20events%20and%20the%20associated%20antibody%20dynamics%20using%20longitudinal%20highly-multiplexed%20serology.%20Nat.%20Commun.14,%201783%20(2023).)]
* 20.Pavela, J. et al. Surveillance for jugular venous thrombosis in astronauts. *Vasc. Med.***27**, 365–372 (2022).
   [[DOI](https://doi.org/10.1177/1358863X221086619)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/35502899/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Pavela,%20J.%20et%20al.%20Surveillance%20for%20jugular%20venous%20thrombosis%20in%20astronauts.%20Vasc.%20Med.27,%20365%E2%80%93372%20(2022).)]
* 21.Auñón-Chancellor, S. M., Pattarini, J. M., Moll, S. & Sargsyan, A. Venous thrombosis during spaceflight. *N. Engl. J. Med.***382**, 89–90 (2020).
...
* 22.Marshall-Goebel, K. et al. Assessment of jugular venous blood flow stasis and thrombosis during spaceflight. *JAMA Netw. Open***2**, e1915011 (2019).
...
* 23.Arbeille, P. et al. Adaptation of the left heart, cerebral and femoral arteries, and jugular and femoral veins during short- and long-term head-down tilt and spaceflights. *Eur. J. Appl. Physiol.***86**, 157–168 (2001).
...
* 24.Arbeille, P., Provost, R., Zuj, K. & Vincent, N. Measurements of jugular, portal, femoral, and calf vein cross-sectional area for the assessment of venous blood redistribution with long duration spaceflight (Vessel Imaging Experiment). *Eur. J. Appl. Physiol.***115**, 2099–2106 (2015).
...
* 25.Clément, G. R. et al. Challenges to the central nervous system during human spaceflight missions to Mars. *J. Neurophysiol.***123**, 2037–2063 (2020).
   [[DOI](https://doi.org/10.1152/jn.00476.2019)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/32292116/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Cl%C3%A9ment,%20G.%20R.%20et%20al.%20Challenges%20to%20the%20central%20nervous%20system%20during%20human%20spaceflight%20missions%20to%20Mars.%20J.%20Neurophysiol.123,%202037%E2%80%932063%20(2020).)]
* 26.Roy-O’Reilly, M., Mulavara, A. & Williams, T. A review of alterations to the brain during spaceflight and the potential relevance to crew in long-duration space exploration. *NPJ Microgravity***7**, 5 (2021).
...
* 27.von Baumgarten, R. J. & Thumler, R. in *Life Sciences and Space Research* Vol. 17 (ed. Holmquist, R.) 161–170 (Pergamon, 1979). [[DOI](https://doi.org/10.1016/b978-0-08-023416-8.50025-8)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/12008702/)]
* 28.Davis, J. R., Vanderploeg, J. M., Santy, P. A., Jennings, R. T. & Stewart, D. F. Space motion sickness during 24 flights of the space shuttle. *Aviat. Space Environ. Med.***59**, 1185–1189 (1988).
...
* 38.Devadhasan, J. P. et al. Point-of-care vertical flow immunoassay system for ultra-sensitive multiplex biothreat-agent detection in biological fluids. *Biosens. Bioelectron.***219**, 114796 (2023).
   [[DOI](https://doi.org/10.1016/j.bios.2022.114796)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/36257115/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Devadhasan,%20J.%20P.%20et%20al.%20Point-of-care%20vertical%20flow%20immunoassay%20system%20for%20ultra-sensitive%20multiplex%20biothreat-agent%20detection%20in%20biological%20fluids.%20Biosens.%20Bioelectron.219,%20114796%20(2023).)]
* 39.Summers, A. J. et al. Optimization of an antibody microarray printing process using a designed experiment. *ACS Omega***7**, 32262–32271 (2022).
   [[DOI](https://doi.org/10.1021/acsomega.2c03595)] [[PMC free article](/articles/PMC9476517/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/36120062/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Summers,%20A.%20J.%20et%20al.%20Optimization%20of%20an%20antibody%20microarray%20printing%20process%20using%20a%20designed%20experiment.%20ACS%20Omega7,%2032262%E2%80%9332271%20(2022).)]
* 40.Diamond, S. G. & Markham, C. H. Prediction of space motion sickness susceptibility by disconjugate eye torsion in parabolic flight. *Aviat. Space Environ. Med.***62**, 201–205 (1991).
...
* 41.Markham, C. H. & Diamond, S. G. A predictive test for space motion sickness. *J. Vestib. Res.***3**, 289–295 (1993).
   [[PubMed](https://pubmed.ncbi.nlm.nih.gov/8275263/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Markham,%20C.%20H.%20&%20Diamond,%20S.%20G.%20A%20predictive%20test%20for%20space%20motion%20sickness.%20J.%20Vestib.%20Res.3,%20289%E2%80%93295%20(1993).)]
* 42.Open science in space. *Nat. Med*. **27**, 1485–1485 (2021). [[DOI](https://doi.org/10.1038/s41591-021-01508-1)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/34522036/)]
* 43.Lee, S. M. C., Feiveson, A. H., Stein, S., Stenger, M. B. & Platts, S. H. Orthostatic intolerance after ISS and space shuttle missions. *Aerosp. Med. Hum. Perform.***86**, A54–A67 (2015).
   [[DOI](https://doi.org/10.3357/AMHP.EC08.2015)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/26630196/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Lee,%20S.%20M.%20C.,%20Feiveson,%20A.%20H.,%20Stein,%20S.,%20Stenger,%20M.%20B.%20&%20Platts,%20S.%20H.%20Orthostatic%20intolerance%20after%20ISS%20and%20space%20shuttle%20missions.%20Aerosp.%20Med.%20Hum.%20Perform.86,%20A54%E2%80%93A67%20(2015).)]
* 44.Meck, J. V., Reyes, C. J., Perez, S. A., Goldberger, A. L. & Ziegler, M. G. Marked exacerbation of orthostatic intolerance after long- vs. short-duration spaceflight in veteran astronauts. *Psychosom. Med.***63**, 865–873 (2001).
   [[DOI](https://doi.org/10.1097/00006842-200111000-00003)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/11719623/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Meck,%20J.%20V.,%20Reyes,%20C.%20J.,%20Perez,%20S.%20A.,%20Goldberger,%20A.%20L.%20&%20Ziegler,%20M.%20G.%20Marked%20exacerbation%20of%20orthostatic%20intolerance%20after%20long-%20vs.%20short-duration%20spaceflight%20in%20veteran%20astronauts.%20Psychosom.%20Med.63,%20865%E2%80%93873%20(2001).)]
* 45.Kelly, T. H., Hienz, R. D., Zarcone, T. J., Wurster, R. M. & Brady, J. V. Crewmember performance before, during, and after spaceflight. *J. Exp. Anal. Behav.***84**, 227–241 (2005).
   [[DOI](https://doi.org/10.1901/jeab.2005.77-04)] [[PMC free article](/articles/PMC1243980/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/16262187/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Kelly,%20T.%20H.,%20Hienz,%20R.%20D.,%20Zarcone,%20T.%20J.,%20Wurster,%20R.%20M.%20&%20Brady,%20J.%20V.%20Crewmember%20performance%20before,%20during,%20and%20after%20spaceflight.%20J.%20Exp.%20Anal.%20Behav.84,%20227%E2%80%93241%20(2005).)]
* 46.Newman, D. J. & Lathan, C. E. Memory processes and motor control in extreme environments. *IEEE Trans. Syst. Man Cybern. C. Appl. Rev.***29**, 387–394 (1999).
   [[DOI](https://doi.org/10.1109/5326.777074)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/11542391/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Newman,%20D.%20J.%20&%20Lathan,%20C.%20E.%20Memory%20processes%20and%20motor%20control%20in%20extreme%20environments.%20IEEE%20Trans.%20Syst.%20Man%20Cybern.%20C.%20Appl.%20Rev.29,%20387%E2%80%93394%20(1999).)]
* 47.Bloomberg, J. J., Reschke, M. F., Clément, G. R., Mulavara, A. P. & Taylor, L. C. *Evidence Report: Risk of Impaired Control of Spacecraft/Associated Systems and Decreased Mobility due to Vestibular/Sensorimotor Alterations Associated with Space Flight* (NASA, 2016).
* 48.Barisic, D. et al. ARID1A orchestrates SWI/SNF-mediated sequential binding of transcription factors with ARID1A loss driving pre-memory B cell fate and lymphomagenesis. *Cancer Cell***42**, 583–604.e11 (2024).
   [[DOI](https://doi.org/10.1016/j.ccell.2024.02.010)] [[PMC free article](/articles/PMC11407687/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/38458187/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Barisic,%20D.%20et%20al.%20ARID1A%20orchestrates%20SWI/SNF-mediated%20sequential%20binding%20of%20transcription%20factors%20with%20ARID1A%20loss%20driving%20pre-memory%20B%20cell%20fate%20and%20lymphomagenesis.%20Cancer%20Cell42,%20583%E2%80%93604.e11%20(2024).)]
* 49.Nangle, S. N. et al. The case for biotech on Mars. *Nat. Biotechnol.***38**, 401–407 (2020).
   [[DOI](https://doi.org/10.1038/s41587-020-0485-4)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/32265561/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Nangle,%20S.%20N.%20et%20al.%20The%20case%20for%20biotech%20on%20Mars.%20Nat.%20Biotechnol.38,%20401%E2%80%93407%20(2020).)]
* 50.Pundyavana, A., Gilad, Y., Stahn, A. C. & Basner, M. Cognition test battery survey: development of a single alertness and mood score for short- and long-duration spaceflight. *Appl. Sci.***13**, 2364 (2023). [[Google Scholar](https://scholar.google.com/scholar_lookup?Pundyavana,%20A.,%20Gilad,%20Y.,%20Stahn,%20A.%20C.%20&%20Basner,%20M.%20Cognition%20test%20battery%20survey:%20development%20of%20a%20single%20alertness%20and%20mood%20score%20for%20short-%20and%20long-duration%20spaceflight.%20Appl.%20Sci.13,%202364%20(2023).)]
* 51.Curran-Everett, D. Multiple comparisons: philosophies and illustrations. *Am. J. Physio. Regul. Integr. Comp. Physio.***279**, R1–R8 (2000). [[DOI](https://doi.org/10.1152/ajpregu.2000.279.1.R1)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/10896857/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Curran-Everett,%20D.%20Multiple%20comparisons:%20philosophies%20and%20illustrations.%20Am.%20J.%20Physio.%20Regul.%20Integr.%20Comp.%20Physio.279,%20R1%E2%80%93R8%20(2000).)]
...
* 53.Hendra, C. et al. Detection of m6A from direct RNA sequencing using a multiple instance learning framework. *Nat. Methods***19**, 1590–1598 (2022).
...
* 54.Wood, D. E., Lu, J. & Langmead, B. Improved metagenomic analysis with Kraken 2. *Genome Biol.***20**, 257 (2019).
   [[DOI](https://doi.org/10.1186/s13059-019-1891-0)] [[PMC free article](/articles/PMC6883579/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/31779668/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Wood,%20D.%20E.,%20Lu,%20J.%20&%20Langmead,%20B.%20Improved%20metagenomic%20analysis%20with%20Kraken%202.%20Genome%20Biol.20,%20257%20(2019).)]
...
* 59.Nayfach, S. et al. CheckV assesses the quality and completeness of metagenome-assembled viral genomes. *Nat. Biotechnol.***39**, 578–585 (2021).
   [[DOI](https://doi.org/10.1038/s41587-020-00774-7)] [[PMC free article](/articles/PMC8116208/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33349699/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Nayfach,%20S.%20et%20al.%20CheckV%20assesses%20the%20quality%20and%20completeness%20of%20metagenome-assembled%20viral%20genomes.%20Nat.%20Biotechnol.39,%20578%E2%80%93585%20(2021).)]
...
* 61.Beaton, K. H., Huffman, W. C. & Schubert, M. C. Binocular misalignments elicited by altered gravity provide evidence for nonlinear central compensation. *Front. Syst. Neurosci.***9**, 81 (2015).
   [[DOI](https://doi.org/10.3389/fnsys.2015.00081)] [[PMC free article](/articles/PMC4451361/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/26082691/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Beaton,%20K.%20H.,%20Huffman,%20W.%20C.%20&%20Schubert,%20M.%20C.%20Binocular%20misalignments%20elicited%20by%20altered%20gravity%20provide%20evidence%20for%20nonlinear%20central%20compensation.%20Front.%20Syst.%20Neurosci.9,%2081%20(2015).)]
* 62.Karmali, F., Ramat, S. & Shelhamer, M. Vertical skew due to changes in gravitoinertial force: a possible consequence of otolith asymmetry. *J. Vestib. Res.***16**, 117–125 (2006).
...
* 63.Markham, C. H., Diamond, S. G. & Stoller, D. F. Parabolic flight reveals independent binocular control of otolith-induced eye torsion. *Arch. Ital. Biol.***138**, 73–86 (2000).
...
* 64.Karmali, F. *Vertical eye misalignments during pitch rotation and vertical translation: evidence for bilateral asymmetries and plasticity in the otolith-ocular reflex*. PhD thesis, Johns Hopkins Univ. (2007).
* 65.Beaton, K. H., Shelhamer, M. J., Roberts, D. C. & Schubert, M. C. A rapid quantification of binocular misalignment without recording eye movements: vertical and torsional alignment nulling. *J. Neurosci. Methods***283**, 7–14 (2017).
   [[DOI](https://doi.org/10.1016/j.jneumeth.2017.03.009)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/28300605/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Beaton,%20K.%20H.,%20Shelhamer,%20M.%20J.,%20Roberts,%20D.%20C.%20&%20Schubert,%20M.%20C.%20A%20rapid%20quantification%20of%20binocular%20misalignment%20without%20recording%20eye%20movements:%20vertical%20and%20torsional%20alignment%20nulling.%20J.%20Neurosci.%20Methods283,%207%E2%80%9314%20(2017).)]
* 66.Basner, M. et al. Continuous and intermittent artificial gravity as a countermeasure to the cognitive effects of 60 days of head-down tilt bed rest. *Front. Physiol.***12**, 643854 (2021).
   [[DOI](https://doi.org/10.3389/fphys.2021.643854)] [[PMC free article](/articles/PMC8009974/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33815148/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Basner,%20M.%20et%20al.%20Continuous%20and%20intermittent%20artificial%20gravity%20as%20a%20countermeasure%20to%20the%20cognitive%20effects%20of%2060%20days%20of%20head-down%20tilt%20bed%20rest.%20Front.%20Physiol.12,%20643854%20(2021).)]
* 67.Basner, M. et al. Effects of head-down tilt bed rest plus elevated CO2 on cognitive performance. *J. Appl. Physiol.***130**, 1235–1246 (2021).
   [[DOI](https://doi.org/10.1152/japplphysiol.00865.2020)] [[PMC free article](/articles/PMC8262780/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33630672/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Basner,%20M.%20et%20al.%20Effects%20of%20head-down%20tilt%20bed%20rest%20plus%20elevated%20CO2%20on%20cognitive%20performance.%20J.%20Appl.%20Physiol.130,%201235%E2%80%931246%20(2021).)]
* 68.Smith, M. G. et al. Effects of six weeks of chronic sleep restriction with weekend recovery on cognitive performance and wellbeing in high-performing adults. *Sleep***44**, zsab051 (2021).
   [[DOI](https://doi.org/10.1093/sleep/zsab051)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33630069/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Smith,%20M.%20G.%20et%20al.%20Effects%20of%20six%20weeks%20of%20chronic%20sleep%20restriction%20with%20weekend%20recovery%20on%20cognitive%20performance%20and%20wellbeing%20in%20high-performing%20adults.%20Sleep44,%20zsab051%20(2021).)]
* 69.Basner, M. et al. Cognition test battery: adjusting for practice and stimulus set effects for varying administration intervals in high performing individuals. *J. Clin. Exp. Neuropsychol.***42**, 516–529 (2020).
   [[DOI](https://doi.org/10.1080/13803395.2020.1773765)] [[PMC free article](/articles/PMC7375457/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/32539487/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Basner,%20M.%20et%20al.%20Cognition%20test%20battery:%20adjusting%20for%20practice%20and%20stimulus%20set%20effects%20for%20varying%20administration%20intervals%20in%20high%20performing%20individuals.%20J.%20Clin.%20Exp.%20Neuropsychol.42,%20516%E2%80%93529%20(2020).)]
* 70.Moore, T. M. et al. Validation of the cognition test battery for spaceflight in a sample of highly educated adults. *Aerosp. Med. Hum. Perform.***88**, 937–946 (2017).
   [[DOI](https://doi.org/10.3357/AMHP.4801.2017)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/28923143/)] [[Google Scholar](https://scholar.google.com/scholar_lookup?Moore,%20T.%20M.%20et%20al.%20Validation%20of%20the%20cognition%20test%20battery%20for%20spaceflight%20in%20a%20sample%20of%20highly%20educated%20adults.%20Aerosp.%20Med.%20Hum.%20Perform.88,%20937%E2%80%93946%20(2017).)]
* 71.Berrios, D. C. et al. NASA GeneLab: interfaces for the exploration of space omics data. *Nucleic Acids Res.***49**, D1515–D1522 (2021). [[DOI](https://doi.org/10.1093/nar/gkaa887)] [[PMC free article](/articles/PMC7778922/)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33080015/)]
* 72.Scott, R. T. et al. Advancing the integration of biosciences data sharing to further enable space exploration. *Cell Rep.***33**, 108441 (2020). [[DOI](https://doi.org/10.1016/j.celrep.2020.108441)] [[PubMed](https://pubmed.ncbi.nlm.nih.gov/33242404/)]
