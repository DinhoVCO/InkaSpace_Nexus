...
Data are presented as the means ± standard deviations of AUC values (*n* = 3). Differences with *P* ≤ 0.05 (Student's *t* test) were considered significant.
